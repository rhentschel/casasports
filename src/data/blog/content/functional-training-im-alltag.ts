...
export const functionalTrainingImAlltag = {
  ...
  title: "Functional Training im Alltag: So verändert es dein Leben",
  excerpt:
    "Functional Training trainiert Bewegungsmuster statt isolierter Muskeln. Warum das gegen Rückenschmerzen hilft, wie es die Alltagsbelastung reduziert und wie du einsteigst.",
  keyTakeaway:
    "Functional Training verbessert alltägliche Bewegungen wie Heben, Tragen, Treppensteigen und beugt Rückenschmerzen vor, weil es Rumpfstabilität, Koordination und Mehrgelenk-Kraft gleichzeitig schult. Studien zeigen signifikante Effekte auf unspezifische Rückenschmerzen, meist nach 8 bis 12 Wochen Training zwei- bis dreimal pro Woche.",
  faq: [
    {
      question: "Was ist der Unterschied zu klassischem Krafttraining?",
      answer:
    ...
    {
      question: "Hilft Functional Training bei Rückenschmerzen?",
      answer:
    ...
    {
      question: "Für welches Alter ist Functional Training geeignet?",
      answer:
    ...
    {
      question: "Kann Functional Training Cardio ersetzen?",
      answer:
    ...
    {
      question: "Was hat Functional Training mit Core-Stabilität zu tun?",
      answer:
  ...
  content: root([
    ...
    heading("h2", "Was genau ist Functional Training?"),
    paragraph(
    ...
    heading("h2", "Die wissenschaftliche Evidenz"),
    paragraph(
      "Das am besten belegte Anwendungsgebiet ist unspezifischer chronischer Rückenschmerz. Die 2025 in Frontiers in Physiology veröffentlichte ",
      link(
        "https://www.frontiersin.org/journals/physiology/articles/10.3389/fphys.2025.1672010/full",
        "Meta-Analyse zu Core Training bei chronischem Rückenschmerz"
      ),
      " verglich drei Varianten: Pilates, Core-Stability-Training und Core-Resistance-Training. Alle drei zeigten signifikante Schmerzreduktion gegenüber Kontrollgruppen. Core-Resistance-Training (also Core-Training mit Widerstand, quasi Functional Training) führte zum stärksten Effekt auf funktionellen Status."
    ),
    paragraph(
    ...
    heading("h2", "Fünf Vorteile im Alltag"),

    heading("h3", "1. Weniger Rückenschmerzen"),
    paragraph(
    ...
    heading("h3", "2. Sichere Haltung in Alltagssituationen"),
    paragraph(
    ...
    heading("h3", "3. Bessere Balance und Sturzprävention"),
    paragraph(
    ...
    heading("h3", "4. Direkte Übertragung in Sport und Beruf"),
    paragraph(
    ...
    heading("h3", "5. Effizienz in wenig Zeit"),
    paragraph(
    ...
    heading("h2", "Ein Einsteiger-Workout in 20 Minuten"),
    paragraph(
    ...
    ul([
      ...
      [bold("Push"), text(": Drücken. Liegestütz, Schulterdrücken, Bankdrücken.")],
      [bold("Pull"), text(": Ziehen. Klimmzüge, Rudern. Wichtig als Gegenpol zur Büro-Vorhaltung.")],
      [bold("Rotate"), text(": Rotieren. Pallof-Press, Medizinball-Würfe. Für Rumpfstabilität bei Drehbewegungen.")],
      [bold("Carry"), text(": Tragen. Farmers Walk, einseitige Carrys. Die unterschätzteste Übung für den ganzen Körper.")],
    ...
    heading("h2", "Was es bei Casa Sports gibt"),
    paragraph(
      "Im Studio findest du einen eigenen ",
      bold("Functional-Bereich"),
      " mit TRX-Schlingen, Kettlebells, Medizinbällen, Plyo-Boxen und Rigs für Klimmzüge und Dips. Unsere Gruppenkurse Functional, Zirkel und Cross-Fitness setzen das Prinzip direkt in strukturierte Sessions um. Wer lieber allein trainiert, bekommt im Einführungstermin einen passenden Plan."
    ),
    ...
    paragraph(
      "Probiere es im ",
      link("/probetraining", "kostenlosen Probetraining", false),
      " oder in unseren Functional-Kursen aus."
    ),
    ...
    ul([
      [
        link(
          "https://www.frontiersin.org/journals/physiology/articles/10.3389/fphys.2025.1672010/full",
          "Core Training Meta-Analysis, Frontiers in Physiology 2025"
        ),
      ],
      [
        link(
          "https://pmc.ncbi.nlm.nih.gov/articles/PMC9340836/",
          "Core Stability Exercises in Non-Specific Low Back Pain (Systematic Review)"
        ),
      ],
      [
        link(
          "https://www.mdpi.com/2411-5142/6/2/37",
          "Efficacy of Core Stability in Chronic Low Back Pain (MDPI)"
        ),
      ],
      [
        link(
          "https://www.frontiersin.org/journals/public-health/articles/10.3389/fpubh.2025.1518612/full",
          "Core Training plus Breathing Exercises for Chronic Low Back Pain"
        ),
      ],
    ]),
  ]),
