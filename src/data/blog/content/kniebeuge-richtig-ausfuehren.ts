...
export const kniebeugeRichtigAusfuehren = {
  slug: "kniebeuge-richtig-ausfuehren",
  title: "Kniebeuge richtig ausführen: Die perfekte Technik Schritt für Schritt",
  excerpt:
    "Die Kniebeuge ist die Königsübung, aber nur mit sauberer Technik. So vermeidest du Rückenrundung, Butt-Wink und typische Anfängerfehler - mit Evidenz aus der Biomechanik.",
  categorySlug: "training",
  authorSlug: "naim",
  coverImagePath: "/images/casasports-personal-training.webp",
  keyTakeaway:
    "Eine technisch saubere Kniebeuge braucht neutrale Wirbelsäule, Ferse am Boden, Knie in Richtung Zehen und Tiefe bis mindestens parallel. Die größte Verletzungsquelle ist Rundung im Rücken unter schwerer Last. Mobilität von Sprunggelenk und Hüfte entscheidet über Technik, nicht die Kraft.",
  faq: [
    {
      question: "Wie tief sollte ich beim Squat gehen?",
      answer:
    ...
    {
      question: "Warum rundet mein Rücken bei tiefen Kniebeugen?",
      answer:
    ...
    {
      question: "Wie breit sollte mein Stand sein?",
      answer:
    ...
    {
      question: "Low Bar oder High Bar?",
      answer:
    ...
    {
      question: "Brauche ich Squat-Schuhe?",
      answer:
    ...
    {
      question: "Sollen die Knie über die Zehen gehen?",
      answer:
    ...
    {
      question: "Kniebeuge mit Kreuzbandverletzung in der Vorgeschichte?",
      answer:
  ...
  content: root([
    ...
    heading("h2", "Was ist eine korrekte Kniebeuge?"),
    paragraph(
    ...
    paragraph(
      ...
      link(
        ...
        "biomechanische Review aus 2024"
      ),
      " bestätigt: Tiefe Kniebeugen sind für Gesunde sicher und erzeugen die höchsten Aktivierungsraten in Gesäßmuskulatur und Oberschenkel. Das Verletzungsrisiko entsteht nicht durch Tiefe, sondern durch Rundung der Wirbelsäule unter Last."
    ),

    heading("h2", "Die 6 Schritte zur perfekten Kniebeuge"),

    heading("h3", "1. Setup und Stand"),
    paragraph(
    ...
    heading("h3", "2. Bracing und Atmung"),
    paragraph(
    ...
    heading("h3", "3. Hip-Hinge + Knie-Beugung zusammen"),
    paragraph(
    ...
    heading("h3", "4. Tiefe und Kontrolle"),
    paragraph(
    ...
    heading("h3", "5. Aufrichten aus der Tiefe"),
    paragraph(
    ...
    heading("h3", "6. Ausatmen nach dem Top"),
    paragraph(
    ...
    heading("h2", "Häufige Fehler und wie du sie fixst"),

    table([
      ["Fehler", "Ursache", "Fix"],
      ["Rundung unterer Rücken", "Steife Hüfte, fehlende Sprunggelenks-Mobility", "Mobility-Drills, weniger tief, Fersen-Erhöhung"],
      ["Knie knicken nach innen", "Schwache Gesäßmuskulatur", "Band um die Knie, Glute-Aktivierung im Warm-up"],
      ["Fersen heben sich", "Sprunggelenks-Mobility", "Squat-Schuhe mit Absatz oder Hantelscheibe unter Fersen"],
      ["Gewicht kippt auf Zehen", "Falsches Setup, Rumpfspannung fehlt", "Fokus auf mittelfuß, bracing verstärken"],
      ["Bar rutscht vom Rücken", "Ellbogen zu weit nach oben", "Oberkörper aufrechter, Ellbogen unter die Bar"],
      ["Butt-Wink in tiefster Position", "Hüft-Mobilität begrenzt", "Pistol-Squat-Arbeit, 90/90 Hüftmobility"],
    ]),

    heading("h2", "Mobility-Voraussetzungen"),
    paragraph(
    ...
    heading("h2", "Progression: Vom Körpergewicht zur Langhantel"),
    ol([
      ...
      [
        text("Woche 9+: Progression nach Plan (siehe "),
    ...
    heading("h2", "Was bei Casa Sports für dich bereit steht"),
    paragraph(
    ...
    paragraph(
      "Buche ein ",
      link("/probetraining", "kostenloses Probetraining", false),
      " und lern die Kniebeuge persönlich mit unserem Team."
    ),
    ...
    ul([
      [
        link(
          "https://pmc.ncbi.nlm.nih.gov/articles/PMC10987311/",
          "Biomechanical Review of the Squat Exercise (PMC 2024)"
        ),
      ],
      [
        link(
          "https://blog.nasm.org/biomechanics-of-the-squat",
          "NASM: Biomechanics of the Squat"
        ),
      ],
      [
        link(
          "https://www.kheljournal.com/archives/2025/vol12issue3/PartC/12-3-14-897.pdf",
          "Full Squats: Performance Benefits and Barriers (2025)"
        ),
      ],
    ]),
  ]),
