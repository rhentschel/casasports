        ...
        <div className="mx-auto mt-16 grid max-w-4xl gap-8 md:grid-cols-2">
          {plans.map((plan) => (
            ...
            >
              ...
              <p className="mt-4 text-[14px] leading-relaxed text-white/35">
                {plan.description}
              </p>
              ...
              <Link
                href="/probetraining"
                className={cn(
                  "group mt-8 flex items-center justify-center gap-3 px-8 py-4 text-[13px] font-medium uppercase tracking-[0.15em] transition-all duration-500",
                  plan.highlighted
